...
public class LatePermitDto
{
    ...
    public LatePermit ConvertToEntity()
    {
        return new LatePermit
        {
            ...
            DateSubmission = this.DateSubmission.HasValue ? this.DateSubmission.Value : DateOnly.FromDateTime(DateTime.Now.ToUniversalTime()),
            TimeIn = this.TimeIn ?? TimeOnly.FromDateTime(DateTime.Now.ToUniversalTime()),
